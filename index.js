...
async function getAccessToken() {
  const consumer_key = "BGdiWF6Wva7PMvyEqfJhlj4c8w0sDj6u926mP9Ax92HS6OoO"; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = "Lkub3bYKjZAaEsAuKw5VvJ7dMJF1F1RFJYAQAAlQNtIBpRH1ovfOCkiVtDCe8TQc"; // REPLACE IT WITH YOUR CONSUMER SECRET
      ...
      axios
        .post(
          url,
          {
            ...
            Amount: "10",
            PartyA: "0114692825", //phone number to receive the stk push
            PartyB: "174379",
            PhoneNumber: "",
